...
public class TelaApresentacao extends JFrame {
	...
	public void init() throws IOException {
		...
		myFont = RegistrarFont.minhaFont(PlanetFont.planetncompactexpand, "40");
		
		// imgAnonymous
		imgAnonymous = new MyLabel(200, 200, ProcessaImagem.processarArredondamento(Images.anonymous));

		imgAnonymous.setLocation((d.width - imgAnonymous.getWidth()) / 2,
				(d.height - imgAnonymous.getHeight()) / 2 - 75);

		// lblAnonymous
		lblAnonymous = new MyLabel(400, 70, "Anonymous", myFont, Color.WHITE, null, SwingConstants.CENTER,
				SwingConstants.CENTER);

		lblAnonymous.setLocation((d.width - lblAnonymous.getWidth()) / 2,
